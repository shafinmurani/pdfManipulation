    ...
    <div class="mergepdf" style="background: #202020;">
        <div class="header">
            ...
            <div class="mergepdf-form">
                ...
                <p>Password : </p><br>
                <input type="password" name="splitInt"><br><br>
                <?php
               session_start();
               if(isset($_POST['submit'])){
                   ...
                   $cmd = "python3 converters/protector.py ".$_SESSION['file1'].' '.$splitInt;
                   shell_exec($cmd);
                   echo "<br><a href='protected/{$final}'>Download Protected PDF.</a><br>";               }
                ?>
                </div>
                    <!-- <br> -->
