    ...
    <div class="mergepdf" style="background: #202020;">
        <div class="header">
            ...
            <div class="mergepdf-form">
                ...
                <p>How many degrees you want the PDF to rotate :</p><br>
               ...
               if(isset($_POST['submit'])){
                   ...
                   $cmd = "python3 converters/rotate.py ".$_SESSION['file1'].' '.$splitInt;
                   shell_exec($cmd);
                   $finalName1 = $final.'.pdf';
                   $finalName2 = $final.'part2'.'.pdf';
                   echo "<br><a href='rotated/{$finalName1}'>Download Rotated PDF.</a><br>";               }
                ?>
                </div>
                    <!-- <br> -->
