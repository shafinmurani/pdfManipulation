                    ...
                    if(in_array($fileActualExt, $allowed)){
                        if($fileErr === 0){
                            if($fileSize < 204800){
                                ...
                                $final = 'convertedToPdf/'.$exploded[0].'.'.$exploded[1].'.pdf/index.php';
                        ...
                        echo "File type unsupported. Please upload a file with a '.html' Extension <br>";
                    }
                    $cmd = "python3 converters/doc-to-pdf.py ".$_SESSION['file1'];
                    // echo $cmd;
                    shell_exec($cmd);
